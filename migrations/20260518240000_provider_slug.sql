...
ALTER TABLE seeks_and_explore_demo.providers
...
UPDATE seeks_and_explore_demo.providers
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY "anon_select_providers"
      ON seeks_and_explore_demo.providers FOR SELECT USING (true);
  END IF;
END$$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY "anon_select_products"
      ON seeks_and_explore_demo.products FOR SELECT USING (true);
  END IF;
END$$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY "anon_select_product_information"
      ON seeks_and_explore_demo.product_information FOR SELECT USING (true);
  END IF;
END$$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY "anon_select_product_images"
      ON seeks_and_explore_demo.product_images FOR SELECT USING (true);
  END IF;
END$$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY "anon_select_product_tags"
      ON seeks_and_explore_demo.product_tags FOR SELECT USING (true);
  END IF;
END$$;
